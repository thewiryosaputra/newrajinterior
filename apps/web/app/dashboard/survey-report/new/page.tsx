        ...
        <section className="min-w-0 px-4 py-6 sm:px-6 xl:px-8">
          <div className="flex flex-col gap-4 border-b pb-5 xl:flex-row xl:items-end xl:justify-between">
            <div>
              ...
              <h1 className="font-display text-4xl font-bold">Input Report Survey</h1>
              <p className="mt-2 text-sm text-newraj-charcoal">Input hasil survey dari client yang dipilih melalui halaman Survey.</p>
            </div>
